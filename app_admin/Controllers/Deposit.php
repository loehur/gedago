...
class Deposit extends Controller
{
   ...
   {
      $data[0] = $this->db(0)->get_where("balance", "balance_type = 1 AND flow = 1 AND tr_status = 0 AND dep_mode = 0 ORDER BY insertTime DESC LIMIT 5");
      $data[1] = $this->db(0)->get_where("balance", "balance_type = 1 AND flow = 1 AND tr_status <> 0 AND dep_mode = 0 ORDER BY insertTime DESC LIMIT 5");

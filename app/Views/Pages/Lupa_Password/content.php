            ...
            <div class="col m-auto" style="max-width: 500px;">
                ...
                <form action="<?= PC::BASE_URL . $con ?>/update_pass" method="POST">
                    <div class="row">
                        <div class="col">
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control shadow-none" name="number" value="<?= isset($_SESSION['log']) ? $_SESSION['log']['hp'] : "" ?>" required id="floatingInput">
                    ...
                    <div class="row mb-1 px-2">
                        <div class="col px-1">
                            <div class="form-floating mb-2">
                                <input type="password" class="form-control shadow-none" name="pass1" required id="floatingInput">
                    ...
                    <div class="row">
                        <div class="col">
                            <button type="submit" class="w-100 border-0 py-2">Simpan</button>
                        </div>
                    </div>
                </form>
            </div>
